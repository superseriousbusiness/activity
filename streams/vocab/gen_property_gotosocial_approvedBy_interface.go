...
// Activity to which this property is attached. The presence of this property
// on an Activity indicates that an interaction has been Approve'd by the
// Actor whose Object this Activity interacts with.
